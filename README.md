...
1. QR Based Attendance System : Teacher can generate a qr (on basis of there class) and student will scan it for getting the attendance of the class. [Student needs to be in the college campus and part of the class for successful scan)
